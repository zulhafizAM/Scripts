...
const AlternateUntrackedLeaveProcessSchema = z.object({
	alternateUntrackedLeaveId: z.number().int().nonnegative(),
...
export default AlternateUntrackedLeaveProcessSchema;