...
@inject()
export default class AllocationAllocationServices {
    constructor(protected commonService: CommonServices) {}
    async getAllocations(payload: Record<string, any>) {
        try {
    ...
    async addAllocation(
        ...
        try {
            let createAllocation = new Allocation()
            createAllocation.useTransaction(trx)
            createAllocation.createdBy = user!.username
