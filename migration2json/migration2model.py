...
def plural(string):
    if string[-7:] == "Process" or string[-6] == "Status":
        plural_string = string + "es"
    elif string[-7:] != "Process" and string[-6] != "Status" and string[-1:] == "y":
        plural_string = string[:-1] + "ies"
    elif string[-7:] != "Process" and string[-6] != "Status" and string[-1:] == "s":
