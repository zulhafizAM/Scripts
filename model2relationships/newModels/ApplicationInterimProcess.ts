...
export default class ApplicationInterimProcess extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof ApplicationInterimProcess>((query) => {
        query
            .preload('application')
    ...
    @column({ columnName: 'applicationId', serializeAs: null })
