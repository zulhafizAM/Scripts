...
export default class PensionDetailProcess extends BaseModel {
    public static table = 'pensionDetailProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof PensionDetailProcess>((query) => {
        query
            .preload('pension')
    ...
    @column({ columnName: 'pensionId', serializeAs: null })
    ...
    @belongsTo(() => PensionDetail, {
        foreignKey: 'pensionId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public pension: BelongsTo<typeof PensionDetail>;
