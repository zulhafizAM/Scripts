...
export default class RemoteReligiousLeaveProcess extends BaseModel {
    public static table = 'remoteReligiousLeaveProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof RemoteReligiousLeaveProcess>((query) => {
        query
            .preload('remoteReligious')
    ...
    @column({ columnName: 'remoteReligiousId', serializeAs: null })
    ...
    @belongsTo(() => RemoteReligiousLeave, {
        foreignKey: 'remoteReligiousId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public remoteReligious: BelongsTo<typeof RemoteReligiousLeave>;
