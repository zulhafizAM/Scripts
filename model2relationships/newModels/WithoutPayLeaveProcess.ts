...
export default class WithoutPayLeaveProcess extends BaseModel {
    public static table = 'withoutPayLeaveProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof WithoutPayLeaveProcess>((query) => {
        query
            .preload('withoutPayLeave')
    ...
    @column({ columnName: 'withoutPayLeaveId', serializeAs: null })
    ...
    @belongsTo(() => WithoutPayLeave, {
        foreignKey: 'withoutPayLeaveId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public withoutPayLeave: BelongsTo<typeof WithoutPayLeave>;
