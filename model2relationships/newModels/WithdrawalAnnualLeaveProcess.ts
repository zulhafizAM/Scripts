...
export default class WithdrawalAnnualLeaveProcess extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof WithdrawalAnnualLeaveProcess>((query) => {
        query
            .preload('withdrawalLeave')
    ...
    @column({ columnName: 'withdrawalLeaveId', serializeAs: null })
    ...
    @belongsTo(() => WithdrawalAnnualLeave, {
