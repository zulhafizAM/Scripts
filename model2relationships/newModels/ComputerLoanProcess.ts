...
export default class ComputerLoanProcess extends BaseModel {
    public static table = 'computerLoanProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof ComputerLoanProcess>((query) => {
        query
            .preload('computerLoan')
    ...
    @column({ columnName: 'computerLoanId', serializeAs: null })
    public computerLoanId: bigint;
    ...
    @belongsTo(() => ComputerLoan, {
        foreignKey: 'computerLoanId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public computerLoan: BelongsTo<typeof ComputerLoan>;
