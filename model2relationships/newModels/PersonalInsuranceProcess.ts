...
export default class PersonalInsuranceProcess extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof PersonalInsuranceProcess>((query) => {
        query
            .preload('insurance')
    ...
    @column({ columnName: 'insuranceId', serializeAs: null })
    ...
    @belongsTo(() => PersonalTravelInsuranceClaim, {
