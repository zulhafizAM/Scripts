...
export default class Performance extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof Performance>((query) => {
        query
            .preload('employee', employeePreloads)
            .preload('PPKEmployee', employeePreloads)
            .preload('PPPEmployee', employeePreloads)
            .preload('performanceContributionNotOfficialDuties');
    });
