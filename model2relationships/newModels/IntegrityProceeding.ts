...
export default class IntegrityProceeding extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof IntegrityProceeding>((query) => {
        query
            .preload('employee', employeePreloads)
            .preload('meeting')
            .preload('disciplinaryType')
            .preload('accussations')
            .preload('sentencings')
            .preload('onSuspensionOrDismissals')
            .preload('cancelSuspensionOrDismissals');
    });
