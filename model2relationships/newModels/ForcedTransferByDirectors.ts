...
export default class ForcedTransferByDirectors extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof ForcedTransferByDirectors>((query) => {
        query
            .preload('employee', employeePreloads)
            .preload('meeting')
            .preload('newPlacement')
            .preload('forcedByDirectorPostponeProcess', (query) =>
                query
                    .preload('approver', employeePreloads)
            )
            .preload('forcedByDirectorProcess', (query) =>
                query
