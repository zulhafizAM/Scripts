...
export default class WithoutPayLeave extends BaseModel {
    public static table = 'withoutPayLeaves';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof WithoutPayLeave>((query) => {
        query
            .preload('employee', employeePreloads)
            .preload('meeting')
            .preload('withoutPayLeaveProcess', (query) =>
                query
    ...
    @hasOne(() => WithoutPayLeaveProcess, {
        foreignKey: 'withoutPayLeaveId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public withoutPayLeaveProcess: HasOne<typeof WithoutPayLeaveProcess>;
