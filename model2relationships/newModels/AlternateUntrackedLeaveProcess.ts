...
export default class AlternateUntrackedLeaveProcess extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof AlternateUntrackedLeaveProcess>((query) => {
        query
            .preload('alternateUntrackedLeave')
    ...
    @column({ columnName: 'alternateUntrackedLeaveId', serializeAs: null })
    ...
    @belongsTo(() => AlternateUntrackedLeave, {
        foreignKey: 'alternateUntrackedLeaveId',
    })
