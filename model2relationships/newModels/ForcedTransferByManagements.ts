...
export default class ForcedTransferByManagements extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof ForcedTransferByManagements>((query) => {
        query
            .preload('employee', employeePreloads)
            .preload('newPlacement')
            .preload('forcedByManagementProcess', (query) =>
                query
                    .preload('supporter', employeePreloads)
                    .preload('approver', employeePreloads)
            )
            .preload('forcedByManagementPostponeProcesses', (query) =>
                query
                    .preload('approver', employeePreloads)
            );
    });
