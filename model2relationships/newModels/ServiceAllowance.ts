...
export default class ServiceAllowance extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof ServiceAllowance>((query) => {
        query
            .preload('allowance')
            .preload('allowanceType')
            .preload('clothingAssistances')
            .preload('stateVisitAllowances')
            .preload('funeralArrangementRequests')
            .preload('employeeWelfareFunds')
            .preload('houseMovingAllowances')
            .preload('passportPaymentClaims')
            .preload('personalTravelInsuranceClaims')
            .preload('cargoShippingReimbursements');
    });
