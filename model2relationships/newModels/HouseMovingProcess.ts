...
export default class HouseMovingProcess extends BaseModel {
    public static table = 'houseMovingProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof HouseMovingProcess>((query) => {
        query
            .preload('houseMoving')
    ...
    @column({ columnName: 'houseMovingId', serializeAs: null })
    ...
    @belongsTo(() => HouseMovingAllowance, {
        foreignKey: 'houseMovingId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public houseMoving: BelongsTo<typeof HouseMovingAllowance>;
