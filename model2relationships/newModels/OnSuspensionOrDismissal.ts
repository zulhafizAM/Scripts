...
export default class OnSuspensionOrDismissal extends BaseModel {
    public static table = 'onSuspensionOrDismissals';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof OnSuspensionOrDismissal>((query) => {
        query
            .preload('integrity');
    });
    ...
    @column({ columnName: 'isEmolumenReceived' })
