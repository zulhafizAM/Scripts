...
export default class AlternateUntrackedLeave extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof AlternateUntrackedLeave>((query) => {
        query
            .preload('employee', employeePreloads)
            .preload('alternateUntrackedLeaveProcess', (query) =>
                query
    ...
    @hasOne(() => AlternateUntrackedLeaveProcess, {
        foreignKey: 'leaveId',
        onQuery: (query) => {
        query.where('active', true);
        },
