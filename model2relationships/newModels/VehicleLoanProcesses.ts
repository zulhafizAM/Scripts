...
export default class VehicleLoanProcesses extends BaseModel {
    public static table = 'vehicleLoanProcesses';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof VehicleLoanProcesses>((query) => {
        query
            .preload('vehicleLoan')
    ...
    @column({ columnName: 'vehicleLoanId', serializeAs: null })
    public vehicleLoanId: bigint;
    ...
    @belongsTo(() => VehicleLoan, {
        foreignKey: 'vehicleLoanId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public vehicleLoan: BelongsTo<typeof VehicleLoan>;
