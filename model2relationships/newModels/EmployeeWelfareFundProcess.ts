...
export default class EmployeeWelfareFundProcess extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof EmployeeWelfareFundProcess>((query) => {
        query
            .preload('welfareFund')
    ...
    @column({ columnName: 'welfareFundId', serializeAs: null })
