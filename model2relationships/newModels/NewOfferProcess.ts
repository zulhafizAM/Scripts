...
export default class NewOfferProcess extends BaseModel {
    public static table = 'newOfferProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof NewOfferProcess>((query) => {
        query
            .preload('newOffer')
    ...
    @column({ columnName: 'newOfferId', serializeAs: null })
    public newOfferId: bigint;
    ...
    public newOffer: BelongsTo<typeof NewOffer>;
