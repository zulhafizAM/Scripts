...
export default class ContractAppointmentsProcess extends BaseModel {
    public static table = 'contractAppointmentsProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof ContractAppointmentsProcess>((query) => {
        query
            .preload('contract')
    ...
    @column({ columnName: 'isFitCritirea' })
