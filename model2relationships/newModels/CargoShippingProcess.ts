...
export default class CargoShippingProcess extends BaseModel {
    ...
    public static withPreloadedList = scope<typeof CargoShippingProcess>((query) => {
        query
            .preload('shipping')
    ...
    @column({ columnName: 'shippingId', serializeAs: null })
    ...
    @belongsTo(() => CargoShippingReimbursement, {
