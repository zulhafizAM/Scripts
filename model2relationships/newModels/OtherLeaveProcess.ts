...
export default class OtherLeaveProcess extends BaseModel {
    public static table = 'otherLeaveProcess';
    public static primaryKey = 'id';
    public static incrementing = false;

    public static namingStrategy = new CamelCaseNamingStrategy();

    public static withPreloadedList = scope<typeof OtherLeaveProcess>((query) => {
        query
            .preload('other')
    ...
    @column({ columnName: 'otherId', serializeAs: null })
    ...
    @belongsTo(() => OtherLeave, {
        foreignKey: 'otherId',
        onQuery: (query) => {
        query.where('active', true);
        },
    })
    public other: BelongsTo<typeof OtherLeave>;
