...
export default class GetVehicleLoanProcessesResponse {
    public vehicleLoanProcesses: VehicleLoanProcessesResponse =
        new VehicleLoanProcessesResponse();
}
export class VehicleLoanProcessesResponse {
    ...
    public getFull(data) {
        this.vehicleLoanId = data.vehicleLoanId;
