...
export default class GetComputerLoanProcessResponse {
    public computerLoanProcess: ComputerLoanProcessResponse =
        new ComputerLoanProcessResponse();
}
export class ComputerLoanProcessResponse {
    ...
    public getFull(data) {
        this.computerLoanId = data.computerLoanId;
