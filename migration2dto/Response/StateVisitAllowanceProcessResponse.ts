...
export default class GetStateVisitAllowanceProcessResponse {
    public stateVisitAllowanceProcess: StateVisitAllowanceProcessResponse =
        new StateVisitAllowanceProcessResponse();
}
export class StateVisitAllowanceProcessResponse {
    ...
    public getFull(data) {
        this.stateVisitedId = data.stateVisitedId;
