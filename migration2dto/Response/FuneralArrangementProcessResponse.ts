...
export default class GetFuneralArrangementProcessResponse {
    public funeralArrangementProcess: FuneralArrangementProcessResponse =
        new FuneralArrangementProcessResponse();
}
export class FuneralArrangementProcessResponse {
    ...
    public getFull(data) {
        this.funeralArrangementId = data.funeralArrangementId;
        this.secretaryVerifierId = data.secretaryVerifierId;
        this.secretaryVerifiedStatus = data.secretaryVerifiedStatus;
        this.secretaryVerifiedRemark = data.secretaryVerifiedRemark;
        this.secretaryVerifiedDate = data.secretaryVerifiedDate;
