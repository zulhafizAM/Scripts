...
export default class GetForcedByManagementProcessResponse {
    public forcedByManagementProcess: ForcedByManagementProcessResponse =
        new ForcedByManagementProcessResponse();
}
