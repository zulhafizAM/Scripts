...
export default class GetPassportPaymentProcessResponse {
    public passportPaymentProcess: PassportPaymentProcessResponse =
        new PassportPaymentProcessResponse();
}
export class PassportPaymentProcessResponse {
    ...
    public getFull(data) {
        this.passportPaymentId = data.passportPaymentId;
