...
export default class GetForcedByDirectorPostponeProcessResponse {
    public forcedByDirectorPostponeProcess: ForcedByDirectorPostponeProcessResponse =
        new ForcedByDirectorPostponeProcessResponse();
}
