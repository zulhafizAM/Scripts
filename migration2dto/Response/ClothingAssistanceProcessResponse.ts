...
export default class GetClothingAssistanceProcessResponse {
    public clothingAssistanceProcess: ClothingAssistanceProcessResponse =
        new ClothingAssistanceProcessResponse();
}
export class ClothingAssistanceProcessResponse {
    ...
    public getFull(data) {
        this.clothingId = data.clothingId;
