...
export default class Promotion154Services {
    public async get154s(
        payload,
    ): Promise<DefaultListResponse<Promotion154sResponse>> {
        let 154s = new DefaultListResponse<Promotion154sResponse>();
        ...
        154s = {
            ...
            dataList: 154List.map((result) => ({
                id: Number(result.id),            })),
        } as DefaultListResponse<Promotion154sResponse>;
